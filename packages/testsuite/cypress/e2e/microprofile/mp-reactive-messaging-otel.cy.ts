describe("TESTS: Configuration => Subsystem => Undertow => Global settings", () => {
  ...
  it("Set AMQP to undefined", () => {
    ...
    cy.verifyAttribute(managementEndpoint, verifyAddress, "amqp-connector", "NEVER");
  });
  ...
  it("Set AMQP to OFF", () => {
    ...
    cy.saveForm(configForm.idNoDash);
    cy.verifyAttribute(managementEndpoint, verifyAddress, "amqp-connector", "OFF");
  });
  ...
  it("Set AMQP to ON", () => {
    ...
    cy.saveForm(configForm.idNoDash);
    cy.verifyAttribute(managementEndpoint, verifyAddress, "amqp-connector", "ON");
  });
  ...
  it("Set AMQP to ALWAYS", () => {
    ...
    cy.saveForm(configForm.idNoDash);
    cy.verifyAttribute(managementEndpoint, verifyAddress, "amqp-connector", "ALWAYS");
  });
  ...
  it("Set Kafka to undefined", () => {
    ...
    cy.saveForm(configForm.idNoDash);
    cy.verifyAttribute(managementEndpoint, verifyAddress, "kafka-connector", "NEVER");
  });
  ...
  it("Set Kafka to OFF", () => {
    ...
    cy.saveForm(configForm.idNoDash);
    cy.verifyAttribute(managementEndpoint, verifyAddress, "kafka-connector", "OFF");
  });
  ...
  it("Set Kafka to ON", () => {
    ...
    cy.saveForm(configForm.idNoDash);
    cy.verifyAttribute(managementEndpoint, verifyAddress, "kafka-connector", "ON");
  });
  ...
  it("Set Kafka to ALWAYS", () => {
    ...
    cy.saveForm(configForm.idNoDash);
    cy.verifyAttribute(managementEndpoint, verifyAddress, "kafka-connector", "ALWAYS");
  });
});
