describe("TESTS: Configuration => Subsystem => JPA", () => {
  ...
  it("Edit default-extended-persistence-inheritance", () => {
    ...
    cy.formInput(configurationFormId, "default-extended-persistence-inheritance").should("have.value", "SHALLOW");
    cy.saveForm(configurationFormId);
    cy.verifySuccess();
    cy.verifyAttribute(managementEndpoint, ["subsystem", "jpa"], "default-extended-persistence-inheritance", "SHALLOW");
  });
